...
<head>
	...
	<title>Home - SMK Negeri 1 Ungaran</title>
...
<body>
	<div class="container bg-light">
		...
		<div class="logo clearfix">
			<div class="float-left mt-3 mb-3">
				...
				<div class="text float-right">
					<span class="smk">SMK Negeri 1 ungaran</span><br>
		...
		<!-- hero image -->
		<div class="hero">
			<img src="resources/images/bannersekolah.jpg" alt="">
		</div>
		...
		<div class="text-white footer">
			2021 © Copyright by ridwan setiawan, andi rahman, taufik hidayat.
		</div>
	</div>
