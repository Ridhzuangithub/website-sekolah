...
--
-- Host: 127.0.0.1
-- Generation Time: 19 Jan 2021 pada 15.38
-- Versi Server: 5.6.21
-- PHP Version: 5.6.3
...
(7, 'Bachtiar Ilmiawan', 1975201602, 'L', '089525461982', 'Cilacap', '1975-06-17', 'Produktif', 'semarang', 'bachtiar-ilmiawan.jpg'),
(14, 'Wahyu Tri Widodo', 1980201803, 'L', '085643529976', 'Cilacap', '1980-06-02', 'Produktif', 'ungaran', 'wahyu-tri-widodo.jpg'),
(15, 'taufik', 2147483647, 'L', '089876555667', 'magelang', '1990-05-19', 'matematika', 'lagensari', 'taufik.png');
...
(4, 'ridwan', 'ridwan', '$2y$10$PPUDnuaKyUC0hKgwMdOZO.0TFNWMGRWjmQQ9LhReRHitqHhC3oRwO', 'ridwan.jpg');
...
(1, 'Fakhrul', 6315, 'L', 'Cilacap', '2002-07-15', 'babadan', '089538018082', 'fakhrul-fanani-nugroho.jpg', 6),
(3, 'Fanani', 6316, 'L', 'Cilacap', '2002-07-16', 'banyumanik', '081929102912', 'fanani.jpg', 6),
(4, 'Nugroho', 6317, 'L', 'Cilacap', '2002-02-18', 'karangjati', '089519291829', 'nugroho.jpg', 6);
...
(1, '<p>Tentang Website SMK Negeri 1 Ungaran&nbsp;dan pembaharuan Versinya.</p><p>Website SMK Negeri 1 Ungaran&nbsp;sebagai media yang dikelola oleh sekolah dan berada di Wilayah Negara Kesatuan Republik Indonesia tentunya Taat dan Patuh sepenuhnya terhadap Hukum dan Perundang Undangan yang berlaku di wilayah Negara Kesatuan Republik Indonesia. Dan mentaati Undang Undang Nomor 19 Tahun 2016 tentang ITE seperti yang tercantum pada tautan berikut&nbsp;<a target="_blank" href="https://www.smkn1wanareja.sch.id/wp-content/uploads/2018/04/UU-19-Tahun-2016-ite.pdf">UU Nomor 19 Tahun 2016</a>.</p><p>Website SMK Negeri 1 Ungaran&nbsp;sebelumnya berada di smk1ungaran.sch.id dan karena suatu hal maka mulai tahun 2018 diluncurkan website dengan alamat baru yaitu www.smkn1ungaran.sch.id. Mulai dikerjakan pada akhir Maret 2018 dan akhirnya bisa online pada tanggal 27 Maret 2018.</p>');
...
ALTER TABLE `tbl_ekskul`
 ADD PRIMARY KEY (`id`), ADD KEY `pembina` (`pembina`);
...
ALTER TABLE `tbl_jurusan`
 ADD PRIMARY KEY (`id`), ADD KEY `tbl_jurusan_ibfk_1` (`ka_prodi`);
